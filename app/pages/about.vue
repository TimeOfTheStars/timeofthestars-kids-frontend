        ...
        <div class="container">
            ...
            <section class="page-surface">
                ...
                <div v-reveal class="school__intro">
                    <p>
                        «Время Звёзд KIDS» — детская хоккейная школа для мальчиков и девочек от 3 до 17 лет. Организация создана в 2024 году для воспитания профессиональных хоккеистов и развития детского хоккея с шайбой.
                    </p>
                    <p>
                        Тренировочный процесс и домашние игры проходят в новом многофункциональном спортивном комплексе ФГБУ ПОО «ГУОР по хоккею» — Ярославль, Дядьковская улица, 7.
                    </p>
                    <p>
                        Наша школа участвует в официальных соревнованиях города и области, проводит собственные турниры и хоккейные сборы.
                    </p>
                </div>
...
useHead({
    title: 'Сведения о хоккейной школе в Ярославле — «Время Звёзд KIDS»',
    meta: [
        {
            name: 'description',
            content:
                'Автономная некоммерческая физкультурно-спортивная организация «ВРЕМЯ ЗВЕЗД» — детская хоккейная школа в Ярославле. Адрес, режим работы, учредители, уставные документы.'
        }
    ],
    link: [
        { rel: 'canonical', href: 'https://timeofthestars-kids.ru/about' }
    ]
})
