...
useHead({
    title: 'Тренеры детской хоккейной школы в Ярославле — «Время Звёзд KIDS»',
    meta: [
        {
            name: 'description',
            content:
                'Команда тренеров детской хоккейной школы в Ярославле: квалификация, спортивный опыт, направления подготовки юных хоккеистов.'
        }
    ],
    link: [
        { rel: 'canonical', href: 'https://timeofthestars-kids.ru/coaches' }
    ]
})
