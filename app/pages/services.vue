<template>
  <div class="page abonementy-page">
    <div class="container">
      <div v-reveal>
        <Breadcrumbs :items="[{ title: 'Услуги' }]" />
      </div>
...
useHead({
  title: 'Услуги хоккейной школы в Ярославле: абонементы, сборы, лагерь — «Время Звёзд KIDS»',
  meta: [
    {
      name: 'description',
      content:
        'Абонементы на детский хоккей в Ярославле, занятия на тренажёре HST, бросковая, хоккейные сборы, летний спортивный лагерь и командная атрибутика. Стоимость и условия.'
    }
  ],
  link: [
    { rel: 'canonical', href: 'https://timeofthestars-kids.ru/services' }
  ]
})
...
const description4 = `❄️ЗИМНИЕ ХОККЕЙНЫЕ СБОРЫ "ВРЕМЯ ЗВЕЗД"
...
- 63000 рублей - с проживанием и питанием на территории базы

☝️При раннем бронировании (до 1 декабря 2026 г.) скидка 🏷️5% (38000 рублей)
