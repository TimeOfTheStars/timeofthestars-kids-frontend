...
const items = [
  ...
  { question: 'Как правильно подобрать высоту клюшки?', answer: 'Чтобы безошибочно подогнать высоту клюшки под собственный рост, следует встать на ровное основание (надев коньки или поднявшись на носочки) и установить клюшку прямо перед собой, разместив крюк между ступнями. Оптимальной длиной для начинающих хоккеистов считается расстояние между подбородком и носом.' },
  { question: 'Какой желоб при заточке коньков предпочтительнее для начинающих хоккеистов?', answer: 'При заточке коньков следует выбирать средний желоб — 15–17.' },
  { question: 'Что входит в экипировку хоккеиста?', answer: `Хоккейный шлем с маской-решёткой — обязательная защита головы игрока.

Защита шеи — отдельная деталь, обязательная защита кадыка, жизненно важных артерий на горле, ключицы, боковой и задней части шеи от порезов лезвиями коньков, ударов клюшкой или прямого попадания летящей на скорости шайбы.

Нагрудник — защита плеч, бицепсов, грудной клетки и спины хоккеиста.

Налокотник — формованные пластиковые вставки, надёжно защитят локоть и предплечье хоккеиста.

Перчатки (краги) — защита пальцев, кисти и нижней части руки.

Защитные трусы (шорты) — защищают живот, пах, нижнюю часть позвоночника, копчик, тазобедренный сустав и поясницу.

Наколенники (щитки) — для защиты голени, ног, коленей.

Коньки — защита ног.

Клюшка — обязательная экипировка игрока в хоккей с шайбой.

Защита для паха (раковина, ракушка, трусы с ракушкой или бандаж).

Также хоккеисту необходимы хоккейные гетры и джерси — верхняя одежда, надевается поверх нагрудника. Имеет логотип команды, порядковый номер игрока и его фамилию.` }
]
